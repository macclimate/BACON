...
%                           Last modification:  Jan 23, 2006
%
%
% Revisions:
%   Jan 23, 2006
%       - changed syntax to work with new chamber calculations
%   Feb 02, 2004
    ...
    try
        ...
        if exist('Stats') == 1
            if isfield(Stats,'Chambers')
                ...
                stats.DecDOY = Stats.Chambers.Time_vector_HH-datenum(Yearx(1),1,0);
                clear Stats;
            else
                stats.Chambers = Stats;
                stats.DecDOY = Stats.Time_vector_HH-datenum(Yearx(1),1,0);
                clear Stats; 
            end
        end
        c = [ 'x1 = ' traceName ';'];
