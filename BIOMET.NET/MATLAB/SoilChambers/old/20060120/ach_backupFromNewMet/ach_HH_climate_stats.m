...
if (strcmp(upper(SiteFlag),'PA') & c.chamber.systemType == 1) | (strcmp(upper(SiteFlag),'BS') & c.chamber.systemType == 1)
...
elseif strcmp(upper(SiteFlag),'JP')  
...
elseif strcmp(upper(SiteFlag),'BS') & c.chamber.systemType ==2
    ...
    for i = 1:numOfHHours_HH;
        ...
        for ch = 1:c.chamber.chNbr
            ...
            %Temp = data_thermocouple(i,ch+(ch-1));            
            %ind = find(Temp ~= -99999);
            Temp = data_thermocouple(i,1:2:23);
            ind = find(Temp ~= -99999 & ~isnan(Temp));
    ...
    %compute data for GR system (CR23X, systemType == 2)
elseif strcmp(upper(SiteFlag),'GR') & c.chamber.systemType ==2
    
%    HH_climate_stats.miscData = call_my_program_that_reads_and_processes_my_data_here;
...
elseif strcmp(upper(SiteFlag),'PA') & c.chamber.systemType ==2
    ...
    %compute data for SOA system (CR23X, systemType == 2)
elseif strcmp(upper(SiteFlag),'YF') & c.chamber.systemType ==2 
...
elseif strcmp(upper(SiteFlag),'ACS') & c.chamber.systemType ==2 
