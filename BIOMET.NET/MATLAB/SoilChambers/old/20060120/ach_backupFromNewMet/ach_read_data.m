...
if (upper(SiteFlag) == 'PA' & systemType == 1) | (upper(SiteFlag) == 'BS' & systemType == 1)
...
elseif upper(SiteFlag) == 'YF' & systemType == 2 | (upper(SiteFlag) == 'BS' & systemType == 2)...
        | (upper(SiteFlag) == 'PA' & systemType == 2) | (upper(SiteFlag) == 'JP' & systemType == 2)
															% if SiteFlag == YF with version 2.0 
                                                            % if SiteFlag == BS with version 2.0
															% if SiteFlag == PA with version 2.0
