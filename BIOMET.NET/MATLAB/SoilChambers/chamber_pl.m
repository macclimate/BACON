...
%       -set plots of OBS chambers to summer mode (winter_mode = 0) (Nick)
% - Nov 4, 2010
%       -set plots of OBS chambers to winter mode (winter_mode = 1) (Nick)
% - Apr 19, 2010
%       -set plots of OBS chambers to summer mode (winter_mode = 0) (Nick)
% - Oct 19, 2009
%       -set plots of OBS chambers to winter mode (winter_mode = 1) (Nick)
...
elseif siteID == 'JP'
   ...
   chNbr = 6;
elseif siteID == 'YF'
  if year<2011 | (year==2011 & ed < 195)
     traceName_ev = 'stats.Chambers.Fluxes_Stats.evOutLong.ev(:,[1:6])';
     traceName_fluxes = 'stats.Chambers.Fluxes_Stats.fluxOutLong.flux(:,[1:6])';
     legendTmp = ['ch01';'ch02';'ch03';'ch04';'ch05';'ch06'];
     chNbr = 6;
   else
     traceName_ev = 'stats.Chambers.Fluxes_Stats.evOutLong.ev(:,[1:9])';
     traceName_fluxes = 'stats.Chambers.Fluxes_Stats.fluxOutLong.flux(:,[1:9])';
     legendTmp = ['ch01';'ch02';'ch03';'ch04';'ch05';'ch06';'ch07';'ch08';'ch09'];
     chNbr = 9;
   end
