function [Efflux,R,P,Effluxgf,Rgf,Pgf,RHat,PHat,RHat0,PHat0,t] = call_ach_co2Efflux2RandP_365day(SiteId,date_start,flag_cleaning,chNum)
%-------------------------------------------------------------------------
...
[Efflux,R,P,Effluxgf,Rgf,Pgf,RHat,PHat,RHat0,PHat0] = ...
    ach_co2Efflux2RandP(t,Efflux,PPFDGF,TaGF,TsGF,PPFDGF,TaGF,TsGF,isNight,[],[],SiteId,chNum); 
