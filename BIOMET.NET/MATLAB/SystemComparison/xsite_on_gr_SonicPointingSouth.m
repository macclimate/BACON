...
% Directional cov
cov_good   = get_stats_field(Stats_all,'XSITE_CP.CovWithDir.cov_wT(1,:,:');

tv_exclude_man = tv( find(tv<=datenum(2005,8,10,1,0,0)...
    | sum(wd_hist(:,23:28),2)<30000 ...
    | precip(ind_db)>0 ));

%    | (wd_xsite<220 | wd_xsite>310)...
