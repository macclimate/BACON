...
% Last Modified by GUIDE v2.5 29-Jul-2008 16:20:23
...
DISmirrorloc = get_gui_string(h_main_figure,'DIS_dir_listbox');
...
switch get(hObject,'Tag')   % Get Tag of selected object
    case 'radio_toDIS'
        handles.pathFlag = 0;
        set(handles.DIS_dir_listbox,'BackgroundColor',[0.584 0.584 0.584]);
    ...
    case 'radio_DISmirror'
        ...
        set(handles.DIS_dir_listbox,'BackgroundColor','white');
end
guidata(hObject,handles);
