...
% Last Modified by GUIDE v2.5 14-May-2014 16:26:24
...
% disp('net use \\annex001\Public\FCRN_DIS_archive arctic /user:biomet');
% dos('net use \\Fluxnet03\Public\FCRN_DIS_archive arctic /user:biomet');
