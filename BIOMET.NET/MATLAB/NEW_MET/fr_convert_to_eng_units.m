...
%                           Last modification:  Oct 4, 2010
%

%
% Revisions: 
%   Oct 4, 2010 (Nick)
%       -for case 99 (LI-7000): flagX sent to fr_licor_c changed from 5 (apply NO corrections) to
%       [ 2 3 4 ], i.e. apply ONLY the dilution correction (mol fraction to
%       mixing ratio). This had implications for PA and BS; PA had to be
%       reaclculated Oct 2005 until present. BS, Oct 2007 till present.
%   March 4, 2008
...
%         EngUnits(5:n,:) = RawData(5:n,:);                           % the rest is in milivolts anyway
    ...
    case 99,
        ...
        disp('...pressure, temp, broadening, corrections not applied...only dilution is!');
        co2             = fr_licor_c( ...
            cp, Tc, Ps, Tbench, ...
            Config_param.CO2_Cal, ...
            EngUnits(6,:), [] , chi, [ 2 3 4 ]);                % Feb19/07: flagX = [ 5] *** this was in error.
                                                                % Oct 4, 2010: use flagX = [ 2 3 4] so only dilution correction occurs
        EngUnits(6,:)   = co2;
