function [x,chi, Pcorr,Tcorr] = fr_licor_h(hp, Th, Ps, Tcell, Cal_poly, v, units, PowX, Tair, Pb, flagX)
%
...
%   
%   May 2, 2007
%       -added flagX to allow for the option of not applying any
%       temp or pressure corrections e.g. in the case of LI-7000 analog data (Nick)
%   Apr. 6, 1999
...
if ~exist('flagX')                                   % if PowX doesn't exist
    flagX = 1;                                       % use PowX = 0.9    
end
...
if flagX ~= 5
    ...
    Pcorr = 1;                     % do not correct for pressure (LI-7000)
    Tcorr = 1;                     % do not correct for temperature (LI-7000)
end
