...
% Revisions:
% Oct 1, 2008
%   - added extraction of table 81 data after another table (82) began being output to
%       the DAT file on Sep 25, 2008 (tree Tc's) (Nick)
...
% read in table number and extract table 81 (table 82 added for tree Tcs Sep 25, 2008)
% (Nick 10/1/08)
tabnum = C(:,1);
ind = find(tabnum==81);
C=C(ind,:);  
