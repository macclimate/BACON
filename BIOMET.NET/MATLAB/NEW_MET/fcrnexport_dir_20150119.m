...
%      end
     ...
     if ~strcmp(upper(pc),'BIOMET01')
       %pth_ex = 'D:\Nick_Share\DIS_export_tests\';
       disp('net use \\BIOMET01\FTP_FLUXNET arctic /user:biomet')
       dos('net use \\BIOMET01\FTP_FLUXNET arctic /user:biomet');
       pth_ex = '\\BIOMET01\FTP_FLUXNET';
     else
        pth_ex = 'G:\FTP_FLUXNET\';
     end
    case 2
