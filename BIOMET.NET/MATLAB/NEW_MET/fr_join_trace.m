function [t,x] = fr_join_trace(traceName,startDay,endDay,fileExt,pth)
%
%  This program joins traces form Frbc CDs recalculated with the new program.
%
...
%				x = joined trace
%
%(c) Eva Jork/Zoran Nesic   File created:       May 07, 1998
%                           Last modification:  Nov 23, 2000
%
%
...
%
%   Nov 23, 2000
%       - atempted to fix the bug that prevented this program from working when
%         the first day or two do not exist.
%   Mar 30, 2000
%       - atempted to fix the bug that caused the program to stop running if
