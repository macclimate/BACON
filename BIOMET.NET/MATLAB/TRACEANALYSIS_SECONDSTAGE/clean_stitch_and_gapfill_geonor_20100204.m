...
arg_default('fill_beg',91);
arg_default('fill_ed',304);
...
ind = find(P_geonor_diff>5 | P_geonor_diff<-5); % finds jumps that are larger than the noise we have been observing in the instrument
