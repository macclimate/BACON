...
% Round the timeVector - this is done for speed. 
% The correct rounding using fr_round_hhour is done later
% timeVector = round(timeVector.*48)./48;
