function data_out = clean_trace(trace_str,interp_flag)
...
% Deal with information from mat-file
if isfield(trace_in,'pts_removed')
   trace_in.data(trace_in.pts_removed) = NaN;
   clean_flags = ta_set_ind(trace_in.pts_removed,clean_flags,'union');
end
if isfield(trace_in,'pts_restored')
   trace_in.data(trace_in.pts_restored) = trace_in.data_old(trace_in.pts_restored);
   clean_flags = ta_set_ind(clean_flags,trace_in.pts_restored,'union');	
end
