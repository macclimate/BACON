...
set (gca,'YLim',[-40 40],'FontSize',8);
set (gca,'YTick',-40:10:40,'FontSize',8);
set (gca,'XTickLabel','');
...
% plot monthly NEP
pl_single_panel(DOY,NEP_FIG,NEP_MONTHLY,'MTH',legstr,1,'g C m^{-2}',[],[],[],2,4,'NEP_{mon}',[.75 .9],10,8,10);
...
% plot monthly R
[ylim_resp,ytck_resp,ytcklab_resp]=pl_single_panel(DOY,R_FIG,R_MONTHLY,'MTH',legstr,1,'g C m^{-2}',[0 ylim_gep(2)],ytck_gep(ytck_gep>=0),ytcklab_gep,2,4,'\itR\rm_{mon}',[.75 .9],10,8,10);
