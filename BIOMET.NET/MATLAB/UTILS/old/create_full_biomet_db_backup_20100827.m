...
% File created: June 6, 2008 (Nick)         Last revision: April 12, 2010
% 
% Revisions:
% April 12, 2010
...
dv=datevec(now);
arg_default('sites',{'CR' 'YF' 'OY' 'BS' 'PA' 'JP' 'HJP02' 'HJP75'});
...
try
   create_biomet_annual_nep_report(dv(1),[base_dir '\database'],fid);
catch
