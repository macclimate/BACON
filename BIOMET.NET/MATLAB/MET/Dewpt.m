function[Tdew,mf_wet,mf_dry,Tdew_target] = dewpt(T,RH,dP,P_atm,P_licor,Td,mf_wet_target)
%To convert DPG output to mmol/mol with no backpressure, dP = 0: 
%           [Tdew,mf_wet,mf_dry] = dewpt(0,0,0,101.47,101.57,8.5,0)
%										 with backpressure on the DPG, dP = 0.45 kPa: 
%           [Tdew,mf_wet,mf_dry] = dewpt(0,0,0.45,101.47,101.57,8.5,0)
...
%   Revisions			
%    June 19, 2008 (Zoran)
%       - Fixed a bug when using the program to convert RH to Tdew
%    May 7, 2003 - added some documentation
%    Mar 9, 2001
%--------------------------------------------------------------------------------------
