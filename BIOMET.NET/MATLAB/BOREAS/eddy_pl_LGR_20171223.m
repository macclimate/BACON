...
%-----------------------------------------------
fig = fig+1;figure(fig);clf;
plot(tv, Sample_intake_temp,'r', tv, Sample_intake_temp-Sample_intake_temp_std,':r', tv, Sample_intake_temp+Sample_intake_temp_std,':r',...
     tv, Sample_end_temp,'b', tv, Sample_end_temp-Sample_end_temp_std, ':b', tv, Sample_end_temp+Sample_end_temp_std, ':b',...
     tv, Sample_mid_temp, 'g', tv, Sample_mid_temp-Sample_mid_temp_std,':g',tv, Sample_mid_temp+Sample_mid_temp_std,':g',...
     tv, TC_Outside, 'k', tv, TC_Outside-TC_Outside_std,':k', tv, TC_Outside+TC_Outside_std,':k');
grid on;
zoom on;
xlabel('DOY')
h = gca;
...
%-----------------------------------------------
fig = fig+1;figure(fig);clf;
plot(tv, Rn, t, H, t, Le, t, Le_LGR, tv, G, t, sum([H Le],2));
grid on;
zoom on;
xlabel('DOY')
h = gca;
