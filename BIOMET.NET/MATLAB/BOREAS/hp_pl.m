...
% Revisions
% Nov 7, 2012 (Hughie)
%   -Added Max/Min Voltage & Snow Depth (HP09)
% Sept 16, 2012 (Hughie)
%   -Added Soil Matrix Potential (HP09), Soil Moisture(HP09) & Hhour/Cumulative Rainfall
%   (HP09&HP11)
% Apr 27, 2012
...
%     Idiag_lgr(ind_bad)=0;
    ...
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [Head_lgr Head_lgrmax Head_lgrmin+0.1 Head_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
    ...
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [ToutTC_lgr ToutTC_lgrmax ToutTC_lgrmin+0.1 ToutTC_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
    ...
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [TinTC_lgr TinTC_lgrmax TinTC_lgrmin+0.1 TinTC_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
    ...
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [Aux_lgr Aux_lgrmax Aux_lgrmin+0.1 Aux_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
    ...
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [DeltaP_lgr DeltaP_lgrmax DeltaP_lgrmin+0.1 DeltaP_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
...
elseif strcmp(SiteID,'HP09')
    trace_name  = [SiteID '-Snow Depth'];
    trace_path = str2mat (fullfile(pthClim, 'Snow_Depth'));
...
%----------------------------------------------------------
% MPS sensors(HP11) & Honeywell sensors (HP09) 
%----------------------------------------------------------
...
if strcmp(SiteID,'HP09')
    ...
    trace_name  = [SiteID '-Matrix Potential'];
trace_path  = str2mat(fullfile(pthSoil,'PressureSensor_kPa_3_Avg'),fullfile(pthSoil,'PressureSensor_kPa_2_Avg'),fullfile(pthSoil,'PressureSensor_kPa_1_Avg'));
trace_legend= str2mat('Honeywell_{20cm}','Honeywell_{50cm}','Honeywell_{80cm}');
trace_units = '(kPa)';
y_axis      = [-100 20];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num,[1 1 1 1 1]); 
