...
if ind(1) > datenum(0,4,15) & ind(1) < datenum(0,11,1);
...
trace_legend = str2mat('fr\_a T Avg','fr\_a T Max','fr\_a T Min','fr\_b T');
trace_units = '(degC)';
...
trace_path  = str2mat(fr_logger_to_db_fileName(ini_climMain, 'Tr3_2mm_AVG', pth),...
                      ...
                      [pth 'uvic_01\uv01a.19'],[pth 'uvic_01\uv01a.20'],...
                      [pth 'uvic_01\uv01a.21'],[pth 'uvic_01\uv01a.22'],...
                      [pth 'uvic_01\uv01a.23']);
...
trace_path  = str2mat(fr_logger_to_db_fileName(ini_climMain, 'HMP_T_1_AVG', pth),...
                      ...
                      fr_logger_to_db_fileName(ini_climMain, 'TC_2m_AVG', pth),...
                      [pth 'fr_b\fr_b.23'],[pth 'fr_f\fr_f.25'],[pth 'fr_f\fr_f.26']);
...
trace_legend = str2mat('downward','upward', '2.5m downward');
...
trace_path  = str2mat(fr_logger_to_db_fileName(ini_climMain, 'PSP_1_AVG', pth),...
                      fr_logger_to_db_fileName(ini_climMain, 'PSP_2_AVG', pth),...
                      fr_logger_to_db_fileName(ini_climMain, 'PSP_3_AVG', pth),...
...
trace_path  = str2mat(fr_logger_to_db_fileName(ini_climMain, 'Net_01_AVG', pth),...
                      fr_logger_to_db_fileName(ini_climMain, 'Net_02_AVG', pth),...
