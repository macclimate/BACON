...
%     Idiag_lgrmin = read_bor(fullfile(pthFl,'Instrument_2.Min_8'));
 ...
 if ECnewLoc
    ...
    disp('IRGA diagnostic plots not available');
end
%--------------------------------------------------------
...
legend('Sonic','IRGA','EC')
    ...
    disp('EC numsamples plot not available');
end
%----------------------------------------------------------
% CO2 mixing ratio
%----------------------------------------------------------
...
%------------------------------------------------
    ...
    disp('Delay times plots not available');
end
% ----------------------------------
% Flow rate - IRGA
% -----------------------------------
...
if pause_flag == 1;pause;end
    ...
    disp('Wind speed plot not available');
end
%----------------------------------------------------------
...
if pause_flag == 1;pause;end
    ...
    disp('Wind direction plot not available');
end
%----------------------------------------------------------
