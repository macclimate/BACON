...
%trace_path  = str2mat([pth 'fr_a\fr_a.24'],[pth 'fr_a\fr_a.79']);
trace_path  = str2mat(  fr_logger_to_db_fileName(ini_climMain, 'TBRG_1_TOT', pth),...
                        fr_logger_to_db_fileName(ini_climMain, 'TBRG_2_TOT', pth),fullfile(pth, 'FR_clearcut','Rain'));
...
trace_path  = str2mat(fullfile(pth, 'FR_clearcut','Sheat_flux_Avg1'),...
                        fullfile(pth, 'FR_clearcut','Sheat_flux_Avg2'),...
                        fullfile(pth, 'FR_clearcut','Sheat_flux_Avg3'),...
                        fullfile(pth, 'FR_clearcut','Sheat_flux_Avg4'));
...
% Soil pit #2_TCs
%----------------------------------------------------------
trace_name  = 'Soil pit #2 TCs';
trace_path  = str2mat(fullfile(pth, 'FR_clearcut','Soil_TC1_3cm_Avg'),...
...
trace_legend = str2mat('3cm TC','10cm TC','20cm TC', '50cm TCS', '80cm TC');
trace_units = 'degC';
y_axis      = [0 50];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units,y_axis, t, fig_num );
...
% Net_Tall tower
%-----------------------------------
trace_name  = 'Tall Tower Net Radiation';
...
trace_name  = 'Short Tower Net Radiation';
T_CNR1 = read_bor(fullfile(pth,'FR_Clearcut','cnr1_Temp_Avg'));
LongWaveOffset =(5.67E-8*(273.15+T_CNR1).^4);
