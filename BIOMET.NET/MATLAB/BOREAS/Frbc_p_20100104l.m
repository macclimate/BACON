...
figure(fig_num);
% vstr = 'Batt_Volt';
% av = read_bor(fullfile(biomet_path(year,'cr','cl'),'WaterQ',[vstr '_AVG']));
% mx = read_bor(fullfile(biomet_path(year,'cr','cl'),'WaterQ',[vstr '_MAX']));
...
av = read_bor(fullfile(biomet_path(year,'cr','cl'),'WaterQ',[vstr '_AVG']));
mx = read_bor(fullfile(biomet_path(year,'cr','cl'),'WaterQ',[vstr '_MAX']));
mn = read_bor(fullfile(biomet_path(year,'cr','cl'),'WaterQ',[vstr '_MIN']));
