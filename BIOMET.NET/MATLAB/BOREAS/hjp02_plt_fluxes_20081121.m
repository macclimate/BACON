...
% Revisions:
% Aug 5, 2008 (Nick)
%   -added HJP94 options and settings
% Apr 23, 2008 Zoran
%   - added         c = fr_get_init('HJP75',currentDate);
%     for HJP75 site. (HJP02 had it but not HJP75?!)
% Nov 2, 2007
...
switch upper(SiteID)
    ...
    case 'HJP75'
        ...
        ext         = '.hhjp75.mat';
        cpIRGA = 2;
        c = fr_get_init('HJP75',currentDate);
    case 'HJP94'
        pth = '\\PAOA001\SITES\hjp94\hhour\';
        ext         = '.hhjp94.mat';
        cpIRGA = 5;
        c = fr_get_init('HJP94',currentDate);
    otherwise
        disp('Uknown site')
end
