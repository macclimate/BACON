...
% BB currents
%----------------------------------------------------------
trace_name  = 'Climate/Diagnostics: System Current';
...
% Power consumption
%----------------------------------------------------------
trace_name  = 'Climate/Diagnostics: Power Consumption';
...
trace_legend = str2mat('Ref','Zero','Cal1','Pneumatic');
trace_units = '(psi)';
y_axis      = [0 2600];
fig_num = fig_num + fig_num_inc;
...
trace_name  = 'Climate: Cumulative Rain #1';
y_axis      = [];
ax = [st ed];
