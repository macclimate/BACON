...
% Air Temp
%----------------------------------------------------------
trace_name  = 'HP09-Air temperature';
...
% Battery Voltage
%----------------------------------------------------------
trace_name  = 'HP09-Battery voltage';
...
% % Battery Current
% %----------------------------------------------------------
% trace_name  = 'HP09-Climate/Diagnostics: Battery Current';
...
% %----------------------------------------------------------
% trace_name  = 'HP09-Climate/Diagnostics: Cumulative Battery Current';
...
% Battery Temperature
%----------------------------------------------------------
% trace_name  = 'HP09-Climate/Diagnostics: Battery Temperature';
...
% Logger Temp
%----------------------------------------------------------
trace_name  = 'HP09-Logger temperature';
...
% % Phone Status
% %----------------------------------------------------------
% trace_name  = 'HP09-Climate/Diagnostics: Phone Diagnostics';
% if SiteID== 'MPB3'
...
% H2O density
%----------------------------------------------------------
trace_name  = 'HP09-Water vapour density';
...
%----------------------------------------------------------
trace_name  = 'HP09-CSAT wind vector components';
...
%----------------------------------------------------------
% trace_name  = 'HP09-Climate/Diagnostics: Rainfall';
...
% HMP Temp
%----------------------------------------------------------
% trace_name  = 'HP09-Climate/Diagnostics: HMP Temperature';
...
% HMP RH
%----------------------------------------------------------
% trace_name  = 'HP09-Climate/Diagnostics: HMP Relative Humidity';
...
% Barometric Pressure
%----------------------------------------------------------
trace_name  = 'HP09-Barometric pressure';
...
% Soil moisture
%----------------------------------------------------------
% trace_name  = 'HP09-Climate/Diagnostics: Soil water content';
% if SiteID == 'MPB3'
...
%----------------------------------------------------------
% if SiteID=='MPB3'
%     trace_name  = 'HP09-Climate/Diagnostics: Air Temp vs. Surface Temp (IR Thermometer)';
...
% if year == 2006;
% 
% trace_name  = 'HP09-Climate/Diagnostics: Soil temperature';
...
% Covariances
%----------------------------------------------------------
trace_name  = 'HP09-Covariance: w*CO2 (raw)';
...
% Covariances
%----------------------------------------------------------
trace_name  = 'HP09-Covariance: w*H2O (raw)';
...
% Covariances
%----------------------------------------------------------
trace_name  = 'HP09-Covariance: w*T (kinematic)';
...
%----------------------------------------------------------
trace_name  = 'HP09-CO2 flux WPL-corrected'; 
...
[Fc_wpl, E_wpl] = apply_WPL_correction(c_w, H_w, T_w, cc, cv, T, P);  %unrotated
[Fc_rot, E_rot] = apply_WPL_correction(wc_rot, wH_rot, wT_rot, cc, cv, T, P);  %rotated

trace_legend= str2mat('CO_{2} WPL 2 rotations', 'CO_{2} WPL unrotated');
...
trace_legend= str2mat('H_{2}O WPL 2 rotations', 'H_{2}O WPL unrotated');
...
% CO2 Flux
%----------------------------------------------------------
trace_name  = 'HP09-CO2 flux computed from flash card data';
...
%----------------------------------------------------------
trace_name  = 'HP09-Wind direction';
...
% Soil Heat Flux
%----------------------------------------------------------
trace_name  = 'HP09-Soil heat flux';
...
% PAR
%----------------------------------------------------------
trace_name  = 'HP09-PAR above canopy';
