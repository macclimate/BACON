...
trace_path  = str2mat([pth 'fr_a\fr_a.5'],[pth 'fr_d\fr_d.5'],[pth 'fr_e\fr_e.5'],[pth 'fr_f\fr_f.5'],[pth 'fr_a\fr_a.46']);
trace_legend = str2mat('fr\_a Avg','fr\_d Avg','fr\_e Avg','fr\_f Avg','BB#2-0.3V');
trace_units = '(V)';
y_axis      = [10 15];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
...
trace_legend = [];
trace_units = 'deg C';
y_axis      = [0 20] - WINTER_TEMP_OFFSET;
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
if pause_flag == 1;pause;end
...
trace_path  = str2mat([pth 'fr_a\fr_a.27'],[pth 'fr_a\fr_a.28'], [pth 'fr_c\fr_c.28'],[pth 'fr_c\fr_c.29'], [pth 'fr_c\fr_c1.5'], [pth 'fr_c\fr_c1.6']);
trace_legend = str2mat('37m (avg)','37m (max)','3.5m (avg)','3.5m (max)', '2.5m (avg)', '2.5m (max)');
trace_units = '(m/s)';
y_axis      = [0 15];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
...
trace_path  = str2mat([pth 'fr_a\fr_a.32'],[pth 'fr_c\fr_c.33'], [pth 'fr_c\fr_c1.10']);
trace_legend = str2mat('38m','3.5m','2.5m');
trace_units = '(m/s)';
y_axis      = [0 360];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
