function [t,x] = hjp02_pl(ind, year, select, fig_num_inc,pause_flag)
...
if year >= 2003
    pth = [biomet_path(year,'HJP02','cl') 'HJP02_23x1\'];      % get the climate data path
    pthCtrl = [biomet_path(year,'HJP02','cl') 'HJP02_10x1\'];      % get the 10x1 data path
...
t=read_bor([ pth 'HJP02_Clim1_dt']);                  % get decimal time from the data base
if year < 2000
...
trace_path  = str2mat([pth 'HJP02_Clim1.7']);
...
trace_path  = str2mat([pth 'HJP02_Clim1.6']);
...
trace_path  = str2mat([pth 'HJP02_Clim1.44'], [pth 'HJP02_Clim1.45'], [pth 'HJP02_Clim1.43']);
trace_legend= str2mat('1m', '2m', '4m');
trace_units = 'Deg C';
y_axis      = [-30 50];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
...
trace_path  = str2mat([pth 'HJP02_Clim1.46'], [pth 'HJP02_Clim1.47']);
trace_legend= str2mat('1m', '2m');
trace_units = '%';
y_axis      = [0 120];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
