...
% Revisions:
% May 16, 2012 (Eugenie)
%   -added 9 log and stumps thermocouples and 3 apogee IRTs.
% Jan 10, 2012 (Eugenie)
...
% CO2 storage
%----------------------------------------------------------
trace_name  = 'HDF11: CO_2 storage';
trace_path  = str2mat(fullfile(pth, 'FR_clearcut','CO2_ppm_Avg'));
                    
trace_legend = str2mat('CO2 storage');
trace_units = 'ppm';
y_axis      = [350 500];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units,y_axis, t, fig_num );
...
% Storage pressure
%----------------------------------------------------------
trace_name  = 'HDF11: Storage pressure';
trace_path  = str2mat(fullfile(pth, 'FR_clearcut','Li_Press_Avg'));
                    
trace_legend = str2mat('Licor pressure');
trace_units = '';
y_axis      = [80 120];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units,y_axis, t, fig_num );
...
trace_path  = str2mat(fullfile(pth, 'FR_clearcut','Sheat_flux1_Avg'),...
                        ...
                        fullfile(pth, 'FR_clearcut','new_SHFP_Avg1'),...
                        fullfile(pth, 'FR_clearcut','new_SHFP_Avg2'),...
                        fullfile(pth, 'FR_clearcut','new_SHFP_Avg3'));
                    
trace_legend = str2mat('SHFP1','SHFP2', 'SHFP3', 'SHFP4','newSHFP1','newSHFP2','newSHFP3');
trace_units = '';
y_axis      = [-150 150];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units,y_axis, t, fig_num );
...
trace_path  = str2mat(fullfile(pth, 'FR_clearcut','Soil_TC1wSHFP1_Avg'),...
                        ...
                        fullfile(pth, 'FR_clearcut','new_soil_tc_Avg1'),...
                        fullfile(pth, 'FR_clearcut','new_soil_tc_Avg2'),...
                        fullfile(pth, 'FR_clearcut','new_soil_tc_Avg3'));
                    
trace_legend = str2mat('TC1wSHFP1','TC2wSHFP2', 'TC3wSHFP3', 'TC4wSHFP4','TC5wSHFP4','newsoiltc1','newsoiltc2','newsoiltc3');
trace_units = 'degC';
y_axis      = [-10 50];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units,y_axis, t, fig_num );
...
% Log and stump TCs
%----------------------------------------------------------
trace_name  = 'HDF11: Log and stump TCs';
trace_path  = str2mat(fullfile(pth, 'FR_clearcut','LS_tc_Avg1'),...
                        fullfile(pth, 'FR_clearcut','LS_tc_Avg2'),...
                        fullfile(pth, 'FR_clearcut','LS_tc_Avg3'),...
                        fullfile(pth, 'FR_clearcut','LS_tc_Avg4'),...
                        fullfile(pth, 'FR_clearcut','LS_tc_Avg5'),...
                        fullfile(pth, 'FR_clearcut','LS_tc_Avg6'),...
                        fullfile(pth, 'FR_clearcut','LS_tc_Avg7'),...
                        fullfile(pth, 'FR_clearcut','LS_tc_Avg8'),...
                        fullfile(pth, 'FR_clearcut','LS_tc_Avg9'));
                    
trace_legend = str2mat('LStc1','LStc2', 'LStc3', 'LStc4','LStc5','LStc6','LStc7', 'LStc8','LStc9');
trace_units = 'degC';
y_axis      = [-10 50];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units,y_axis, t, fig_num );
...
%----------------------------------------------------------
trace_name  = 'HDF11: Infrared thermometers';
trace_path  = str2mat(  fullfile(pth, 'FR_clearcut','CTT_C1_Avg'),...
                        fullfile(pth, 'FR_clearcut','CTT_C2_Avg'),...
                        fullfile(pth, 'FR_clearcut','CTT_C3_Avg'));
                    
trace_legend = str2mat('IRT1','IRT2','IRT3');
trace_units = 'degC';
y_axis      = [-10 50];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units,y_axis, t, fig_num );
