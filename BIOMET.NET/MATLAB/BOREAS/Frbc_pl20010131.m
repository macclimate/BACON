...
trace_path  = str2mat([pth 'fr_a\fr_a.27'], [pth 'fr_c\fr_c.28'], [pth 'fr_c\fr_c1.5']);
trace_legend = str2mat('37m (avg)','3.5m (avg)','2.5m (avg)');
trace_units = '(m/s)';
y_axis      = [0 8];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
...
trace_path  = str2mat([pth 'fr_a\fr_a.28'],[pth 'fr_c\fr_c.29'], [pth 'fr_c\fr_c1.6']);
trace_legend = str2mat('37m (max)','3.5m (max)', '2.5m (max)');
trace_units = '(m/s)';
y_axis      = [0 15];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
