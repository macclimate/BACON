...
%-----------------------------------
trace_name  = 'CNR1 Net Radiation components';
...
figure(fig_num);
vstr = 'BattVolt';
av = read_bor(fullfile(biomet_path(year,'cr','cl'),'WaterQ\10min',[vstr '_Avg']));
mx = read_bor(fullfile(biomet_path(year,'cr','cl'),'WaterQ\10min',[vstr '_Max']));
mx1 = interp1(t,mx(ind),t_10min);
mn = read_bor(fullfile(biomet_path(year,'cr','cl'),'WaterQ\10min',[vstr '_Min']));
