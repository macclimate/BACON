...
% %----------------------------------------------------------
% trace_name  = 'Tall Tower HMP air temperatures';
...
%----------------------------------------------------------
trace_name  = 'HMP air temperatures';
trace_path  = str2mat(  fr_logger_to_db_fileName(ini_climMain, 'HMP_T_1_AVG', pth),...
                        fr_logger_to_db_fileName(ini_climMain, 'HMP_T_2_AVG', pth),...
                        fr_logger_to_db_fileName(ini_climMain, 'HMP_T_3_AVG', pth),...
...
trace_path  = str2mat([pth 'fr_clim\fr_clim_105.5'], [pth 'fr_f\fr_f.5'],[pth 'fr_b\fr_b.5'], [pth 'fr_c\fr_c.5']);
trace_legend = str2mat('FR\_Clim\_avg','FR\_F\_avg','FR\_B\_avg','FR\_C\_avg');
trace_units = '(V)';
y_axis      = [10.5 14];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
...
if pause_flag == 1;pause;end
%----------------------------------------------------------
% Panel temperatures_Tall and small towers
%----------------------------------------------------------
...
trace_legend = str2mat('fr\_clim T Avg','fr\_b T Avg','short-tower T Avg');
trace_units = '(degC)';
...
% Sampling tube temp.
%----------------------------------------------------------
trace_name  = 'NEEDS UPDATING to Clearcut: Sample tube temp';
...
% Snow temperatures 
%----------------------------------------------------------
trace_name  = 'NEED REPLACING: Snow temperatures';
...
% % CNR1 temperature
% %----------------------------------------------------------
% trace_name  = 'Tall tower CNR1 temperature';
% trace_path  = str2mat(  fr_logger_to_db_fileName(ini_climMain, 'HMP_T_2_AVG', pth),...
%                         fr_logger_to_db_fileName(ini_climMain, 'T_Pt100_AVG',pth));
%                      
%                         %[pth 'fr_a\fr_a.17'],[pth 'fr_a\fr_a.75'],[pth 'fr_a\fr_a.85']);
% trace_legend = str2mat('HMP\_41m Met-1','CNR1_PRT');
% trace_units = '(degC)';
% y_axis      = [0 35] - WINTER_TEMP_OFFSET;
% fig_num = fig_num + fig_num_inc;
% x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
...
trace_path  = str2mat(  fr_logger_to_db_fileName(ini_climMain, 'HMP_T_2_AVG', pth),...
                        fr_logger_to_db_fileName(ini_climMain, 'T_Pt100_AVG',pth),fullfile (pth, 'FR_clearcut','HMP_T_Avg'),fullfile(pth,'FR_clearcut','cnr1_PRT_Avg'));
                     
                        %[pth 'fr_a\fr_a.17'],[pth 'fr_a\fr_a.75'],[pth 'fr_a\fr_a.85']);
trace_legend = str2mat('HMP\_41m Met-1','Tall CNR1 PRT','Short HMP T','Short CNR1 PRT');
trace_units = '(degC)';
y_axis      = [0 35] - WINTER_TEMP_OFFSET;
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
...
%-----------------------------------
trace_name  = 'Tall Tower CNR1 Net Radiation components';
...
%-----------------------------------
trace_name  = 'Short Tower CNR1 Net Radiation components';
T_CNR1 = read_bor(fullfile(pth,'FR_Clearcut','cnr1_PRT_Avg'));
LongWaveOffset =(5.67E-8*(273.15+T_CNR1).^4);
...
S_upper_AVG = read_bor(fullfile(pth,'FR_Clearcut','swd_Avg'));
S_lower_AVG = read_bor(fullfile(pth,'FR_Clearcut','swu_Avg'));
L_upper_AVG = read_bor(fullfile(pth,'FR_Clearcut','lwd_Avg')) + LongWaveOffset;
L_lower_AVG = read_bor(fullfile(pth,'FR_Clearcut','lwu_Avg')) + LongWaveOffset;
...
%trace_legend = str2mat('Net_{logger}','S_{upper}','S_{lower}','L_{upper}','L_{lower}','Net_{calc}');
trace_legend = str2mat('S_{upper}','S_{lower}','L_{upper}','L_{lower}','Net_{calc}');
trace_units = '(W/m^2)';
y_axis      = [-200 1000];
fig_num = fig_num + fig_num_inc;
x_all = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num);
...
% trace_path  = str2mat([pth 'WaterQ\10min\BattVolt_Avg']);
% trace_legend = str2mat('AVG','MAX','MIN');
% trace_units = '(V)';
% y_axis      = [11 14];
% fig_num = fig_num + fig_num_inc;
% %t_10min = read_bor(fullfile(pth,'WaterQ','WaterQ1_181_dt'));
% t_10min = read_bor(fullfile(pth,'WaterQ\10min','TimeVector'),8);
% t_10min = t_10min-datenum(year,1,0);
% t_10min = t_10min - offset_doy - GMTshift;
% ind_10min = find( t_10min >= st & t_10min <= ed );
% 
% 
% figure(fig_num);
% vstr = 'BattVolt';
% av = read_bor(fullfile(biomet_path(year,'HDF11','cl'),'WaterQ\10min',[vstr '_Avg']));
% mx = read_bor(fullfile(biomet_path(year,'HDF11','cl'),'WaterQ\10min',[vstr '_Max']));
% mx1 = interp1(t,mx(ind),t_10min);
% mn = read_bor(fullfile(biomet_path(year,'HDF11','cl'),'WaterQ\10min',[vstr '_Min']));
% mn1 = interp1(t,mn(ind),t_10min);
% t_10min = t_10min(ind_10min);
% x = plt_msig( [av(ind_10min) mx(ind_10min) mn(ind_10min)], ind_10min, trace_name, trace_legend, year, trace_units, y_axis, t_10min, fig_num );
% 
...
%----------------------------------------------------------
trace_name  = 'Tall Tower Air temperatures at 35m and 42m';
...
% Wind speed (RM Young)
%----------------------------------------------------------
trace_name  = 'Tall Tower Wind speed averages (RM Young)';
...
%----------------------------------------------------------
trace_name  = 'Tall Tower Wind speed (max)(RM Young)';
...
%----------------------------------------------------------
trace_name  = 'Tall Tower Wind directions (RM Young)';
...
% % PAR 1,2_Short tower
% %-----------------------------------
trace_name  = 'Short Tower PAR ';
trace_path  = str2mat([pth 'fr_a\fr_a.38'],[pth 'fr_a\fr_a.40']);
trace_path  = str2mat(fullfile(pth, 'FR_clearcut','PAR_Avg1'),fullfile(pth, 'FR_clearcut','PAR_AVG2'));
...
%----------------------------------------------------------
trace_name  = 'UPDATE using FR_clearcut traces: H_{Gill}, H_{tc}, LE and Rn';
