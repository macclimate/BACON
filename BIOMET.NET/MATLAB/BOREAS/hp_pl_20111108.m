...
if strcmp(SiteID,'HP09')
    ...
    trace_legend= str2mat('logger','EC');
    trace_units = '';
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [Chopper_lgr Chopper_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
    ...
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [Detector_lgr Detector_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
    ...
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [PLL_lgr PLL_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
    ...
    y_axis      = [0 1];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [Sync_lgr Sync_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
    ...
    y_axis      = [0 100];
    fig_num = fig_num + fig_num_inc;
    x = plt_msig( [AGC_lgr AGC_EC], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
    if pause_flag == 1;pause;end
