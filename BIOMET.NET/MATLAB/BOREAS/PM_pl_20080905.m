...
trace_path  = str2mat(fullfile(pth_MET1,'Batt_Volt_AVG'),fullfile(pth_Transect,'Batt_Volt_AVG'),fullfile(pth_Transect,'Phone_Vlt_AVG'),fullfile(pth_MET1,'PM_Clim.34'));
