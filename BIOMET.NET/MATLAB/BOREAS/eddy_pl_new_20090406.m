...
if strcmp(upper(SiteID),'YF')
    [Tbench]    = get_stats_field(StatsX,'Instrument(5).Avg(3)');
    [Tbench_Min]= get_stats_field(StatsX,'Instrument(5).Min(3)');
    [Tbench_Max]= get_stats_field(StatsX,'Instrument(5).Max(3)');

    [Plicor]    = get_stats_field(StatsX,'Instrument(5).Avg(4)');
    [Plicor_Min]= get_stats_field(StatsX,'Instrument(5).Min(4)');
    [Plicor_Max]= get_stats_field(StatsX,'Instrument(5).Max(4)');
    
    [Dflag5]    = get_stats_field(StatsX,'Instrument(1).Avg(5)');
    [Dflag5_Min]= get_stats_field(StatsX,'Instrument(1).Min(5)');
    [Dflag5_Max]= get_stats_field(StatsX,'Instrument(1).Max(5)');
    
    [Dflag6]    = get_stats_field(StatsX,'Instrument(5).Avg(6)');
    [Dflag6_Min]= get_stats_field(StatsX,'Instrument(5).Min(6)');
    [Dflag6_Max]= get_stats_field(StatsX,'Instrument(5).Max(6)');

    numOfSamplesIRGA = get_stats_field(StatsX,'Instrument(5).MiscVariables.NumOfSamples');
    numOfSamplesSonic = get_stats_field(StatsX,'Instrument(1).MiscVariables.NumOfSamples');
    ...
    [Tbench]    = get_stats_field(StatsX,'Instrument(4).Avg(3)');
    [Tbench_Min]= get_stats_field(StatsX,'Instrument(4).Min(3)');
    [Tbench_Max]= get_stats_field(StatsX,'Instrument(4).Max(3)');

    [Plicor]    = get_stats_field(StatsX,'Instrument(4).Avg(4)');
    [Plicor_Min]= get_stats_field(StatsX,'Instrument(4).Min(4)');
    [Plicor_Max]= get_stats_field(StatsX,'Instrument(4).Max(4)');
...
if c.Instrument(IRGAnum).Delays.Samples ~= [ 0 0 ]
