...
numOfSamplesEC = get_stats_field(StatsX,'MainEddy.MiscVariables.NumOfSamples');
    ...
    [Dflag5]    = get_stats_field(StatsX,[instrumentString 'Avg(5)']);
    [Dflag5_Min]= get_stats_field(StatsX,[instrumentString 'Min(5)']);
    [Dflag5_Max]= get_stats_field(StatsX,[instrumentString 'Max(5)']);
    
    [Dflag6]    = get_stats_field(StatsX,[instrumentString 'Avg(6)']);
    [Dflag6_Min]= get_stats_field(StatsX,[instrumentString 'Min(6)']);
    [Dflag6_Max]= get_stats_field(StatsX,[instrumentString 'Max(6)']);
