...
trace_legend= str2mat('HMP_top','HMP_{Vent}','PRT_{vent}','Tc_{Vent}');
trace_units = '(degC)';
...
if year>= 2012
    trace_name  = 'Net Radiation comparison';
    trace_legend= str2mat('CNR1 (calculated)','Middleton (Boom)');
x = plt_msig( [ RnCNR1 RnMid], ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num);
else
...
% Soil Temp profile 1
%-----------------------------------
trace_name  = 'Soil Tc profile 1';
trace_path  = str2mat([pth 'BS_21x_4\BS_4.6'],[pth 'BS_21x_4\BS_4.7'], ...
                      [pth 'BS_21x_4\BS_4.8'],[pth 'BS_21x_4\BS_4.9'],[pth 'BS_21x_4\BS_4.10'],...
                       [pth 'BS_21x_4\BS_4.26'] );
trace_legend= str2mat('5 cm','10 cm','20 cm','50 cm','100 cm','PanelT');
trace_units = '\circC';
y_axis      = [ -150 35 ] - WINTER_TEMP_OFFSET;
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
if pause_flag == 1;pause;end
...
% Soil Temp profile 2
%-----------------------------------
trace_name  = 'Soil Tc profile 2';
trace_path  = str2mat([pth 'BS_21x_4\BS_4.11'],[pth 'BS_21x_4\BS_4.12'], ...
                      [pth 'BS_21x_4\BS_4.13'],[pth 'BS_21x_4\BS_4.14'],[pth 'BS_21x_4\BS_4.15'],...
                       [pth 'BS_21x_4\BS_4.26']);
trace_legend= str2mat('5 cm','10 cm','20 cm','50 cm','100 cm','PanelT');
trace_units = '\circC';
y_axis      = [ -150 35 ] - WINTER_TEMP_OFFSET;
