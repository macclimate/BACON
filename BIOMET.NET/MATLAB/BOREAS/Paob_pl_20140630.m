...
trace_legend= str2mat('BS1_Min','BS1_Avg','BS2_Max','OB8','OB7','OBN','OBT');
trace_units = 'volts';
y_axis      = [10 15];
fig_num = fig_num + fig_num_inc;
x = plt_msig( trace_path, ind, trace_name, trace_legend, year, trace_units, y_axis, t, fig_num );
...
trace_path  = str2mat([pth 'BS_CR7_3\BS_3.22'],[pth 'BS_23x_5\HMP_T_1_AVG'],[pth 'BS_CR7_3\BS_3.24'],[pth 'BS_CR7_3\BS_3.25'],...
                      [pth 'BS_CR7_3\BS_3.33'],[pth 'OBN\OBN.20']);
...
trace_path  = str2mat([pth 'BS_CR7_3\BS_3.48'],[pth 'BS_CR7_3\BS_3.57']);
...
trbS10=read_bor(fullfile(pth,'OBT\OBT.18'))-Tref1+Tref2;
