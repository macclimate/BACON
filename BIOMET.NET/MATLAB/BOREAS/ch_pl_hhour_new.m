function [chamber_data] = ch_pl_hhour_new(x,SiteID);
% Program that defines paths to retrieve comma delimited files for new chamber system (JP) and where to 
...
A = fr_get_doy(x.Chambers.Time_vector_HH_HF,0);
