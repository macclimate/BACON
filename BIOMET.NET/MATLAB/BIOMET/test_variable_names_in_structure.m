...
% test_variable_names_in_structure(trc,stage)
% 
% Check which names are missing the trc structure for stage.
% trc is the output of read_data, stage is either 2 or 3
% depending on the stage to be tested.
