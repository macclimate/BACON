...
Sites     = {'BS' 'CR' 'JP' 'PA' 'OY' 'YF'};
hhour_new = {'BS' 'CR' 'PA' 'OY' 'YF'}; % sites for which we receive HF data
Site_name = {'PAOB' 'CR' 'PAOJ' 'PAOA' 'OY' 'YF'};
Site_eddy = {'Eddy' 'Eddy' 'Eddy' 'Eddy' 'MainEddy' 'MainEddy'};
...
%    end
   ...
   if ismember(Sites(i),hhour_new) % only applies to sites we get HF data from
