...
All_Sites     = {'BS' 'CR' 'FEN' 'HJP02' 'HJP75' 'HJP94' 'JP' 'PA' 'OY' 'YF' ...
                    'MPB1' 'MPB2' 'MPB3' 'MPB4' 'HP09' 'HP11' 'HDF11' 'SQT' 'SQM' 'LGR1'};
...
All_Site_eddy = {'Eddy' 'Eddy' 'MainEddy' 'MainEddy' 'MainEddy' 'MainEddy' 'Eddy' 'Eddy' 'MainEddy' 'MainEddy'...
                  'MPB_Eddy' 'MPB_Eddy' 'MPB_Eddy' 'MainEddy' 'MainEddy' 'MainEddy' 'MainEddy' 'MainEddy' 'MainEddy' 'MainEddy'};
...
for i = 1:n
    ...
    for j = 1:m
        ...
        %------------------------------------------------------------------
        switch upper(SiteId)
            case {'FEN' 'HJP02' 'HJP75'  'HJP94' 'OY' 'MPB1' 'MPB2' 'MPB3' 'MPB4' 'HP09' 'HP11' 'HDF11' 'SQT' 'SQM' 'LGR1'}
                wc = ['*.h' SiteId '.mat'];
            case {'PA'}
                if year<2011 
                    wc = ['*.h' SiteId(1) '.mat'];
