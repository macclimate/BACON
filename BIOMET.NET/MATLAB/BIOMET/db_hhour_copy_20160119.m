...
if now - lastTime >= 1-1/24  % July 3, 2007: Nick changed
    ...
    %for YearX = dateVec(1) % stop doing the previous year on every run, Nick July 8, 2011
        ...
        dos(cmdStr)
        cmdStr = ['xcopy \\biomet01\HFREQ_BS\met-data\hhour\' strYear(3:4) '????.hb.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
        cmdStr = ['xcopy \\biomet01\HFREQ_BS\met-data\hhour\' strYear(3:4) '????.hb_ch.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
        % for new eddy files
        cmdStr = ['xcopy \\biomet01\HFREQ_BS\met-data\hhour\' strYear(3:4) '????.hBS.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
...
%         dos(cmdStr)
        ...
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['xcopy \\biomet01\HFREQ_PA\met-data\hhour\' strYear(3:4) '????.hp.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
        cmdStr = ['xcopy \\biomet01\HFREQ_PA\met-data\hhour\' strYear(3:4) '????.hp_ch.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
        % for new eddy files
        cmdStr = ['xcopy \\biomet01\HFREQ_PA\met-data\hhour\' strYear(3:4) '????.hPA.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
        ...
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['xcopy \\biomet01\HFREQ_YF\met-data\hhour\' strYear(3:4) '????.hy.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
        cmdStr = ['xcopy \\biomet01\HFREQ_YF\met-data\hhour\' strYear(3:4) '????.hy_ch.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
        ...
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['xcopy \\biomet01\HFREQ_MPB1\met-data\hhour\' strYear(3:4) '????.hMPB1.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
...
%         dos(cmdStr)
        ...
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['xcopy \\biomet01\HFREQ_HP11\met-data\hhour\' strYear(3:4) '????.hHP11.mat ' pthHH_db '  /D /F /Y >' '> ' pthHH_db '\hhour_copy.log' ];
        dos(cmdStr)
	end
