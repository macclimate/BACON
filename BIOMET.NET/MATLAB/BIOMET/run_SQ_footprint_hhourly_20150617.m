...
SiteInfo.tv = dateIn;
SiteInfo.h_c = 0.05; %canopy height in meter
...
FileName_p = FR_DateToFileName(fr_round_time(dateIn,'30min',3));
A = getframe(gcf);
imwrite(A.cdata, fullfile(pthOut,['SQM_flux_footprint_' FileName_p '.jpeg']));
