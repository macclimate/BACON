...
%-------------------Remove these lines once updated-----------
disp('>>> THIS FUNCTION IS OBSOLETE AND NEEDS UPDATING BEFORE IT WILL WORK WITH <<<');
disp('>>> NEW NETWORK PATHS. EXITING FOR NOW... MERRY CHRISTMAS...Nick, Dom and Zoran Dec 19, 2007 <<<');
