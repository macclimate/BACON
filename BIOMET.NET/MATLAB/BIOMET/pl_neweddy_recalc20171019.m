...
[dataPth,hhourPth] = FR_get_local_path;
...
for n=1:48
    ...
    switch upper(siteId)
        ...
        case 'YF'
            StatsX_msg(n).EnclosedPathEddy.Three_Rotations.AvgDtr.Fluxes.Fc = NaN;
            StatsX_msg(n).EnclosedPathEddy.Three_Rotations.AvgDtr.Fluxes.LE_L = NaN;
            StatsX_msg(n).EnclosedPathEddy.Three_Rotations.AvgDtr.Fluxes.Hs = NaN;
            StatsX_msg(n).EnclosedPathEddy.Three_Rotations.Avg(1:6) = NaN.*ones(1,6);
    end
end
...
for j=1:length(dataset);
    ...
    if strcmp(char(dataset{j}),'new')
        ...
        Delay_CO2_new  = get_stats_field(StatsX,'MainEddy.Delays.Implemented(1)');
        Delay_H2O_new  = get_stats_field(StatsX,'MainEddy.Delays.Implemented(2)');
        ...
        NumOfSamples_new.EC  = get_stats_field(StatsX,'MainEddy.MiscVariables.NumOfSamples');
        ...
        Delay_CO2_old  = get_stats_field(StatsX,'MainEddy.Delays.Implemented(1)');
        Delay_H2O_old  = get_stats_field(StatsX,'MainEddy.Delays.Implemented(2)');
        ...
        NumOfSamples_old.EC  = get_stats_field(StatsX,'MainEddy.MiscVariables.NumOfSamples');
        t_old=t;
    end
end
