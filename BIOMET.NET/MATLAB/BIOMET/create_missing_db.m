...
% Nick added YF 2010/02/10... no one noticed missing db because no-one has
% bothered to clean data since 2006
fr_set_site('yf','n')
x = DB_create_chambers([pth_db num2str(Year) '\yf\chambers\'],Year,'yf');
