...
%   - added LGR1 site to the list of sites to process
%
% Sept 22, 2015
%  -removed HP09 from site updates, all BERMS-MSC updates turned off
%  (BERMS-MSC server not online since 2013).
% Aug 21, 2014
...
if runCleaning == 1
    ...
    if local_export % do daily export to our local copy of the FCRN db (for internal use only)
        ...
        sites = {'BS' 'PA' 'YF' 'UBC_TOTEM' 'MPB1' 'HP11' 'LGR1'}; 
...
eval_wrapper('Exporting HP web plots','fr_automated_cleaning(yy(1),{''HP11''},6);');
