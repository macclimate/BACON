...
standardTime = 5;                   % download data for the 24hours ending at 4am STANDARD time
...
if emailEnable == 1 
    ...
    %sendmail({'zoran.nesic@ubc.ca','grutzmacherB@TimberWest.com','dhcc@shaw.ca','wheelert@timberwest.com','jekline@timberwest.com'},sprintf('Piggot & Buckley site reports for %s',datestr(singleDay,1)),' ',fileAttachment);
    sendmail({'zoran.nesic@ubc.ca','grutzmacherB@TimberWest.com','dhcc@shaw.ca','aalgaardma@timberwest.com','jekline@timberwest.com'},sprintf('Piggot & Buckley site reports for %s',datestr(singleDay,1)),' ',fileAttachment);
