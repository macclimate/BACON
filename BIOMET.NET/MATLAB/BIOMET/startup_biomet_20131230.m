...
if server == 1
    ...
    set_all_biomet_paths('c:\biomet.net','c:\ubc_pc_setup\site_specific','c:\ubc_pc_setup\pc_specific','d:\met-data\hhour','d:\met-data\hhour','d:\met-data\data','d:\met-data\csi_net','\\annex001\database','d:\nz\matlab');
else
    try
