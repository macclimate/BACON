...
elseif Year < 1996 & ~strcmp(upper(SiteID),'UBC_TOTEM')
    error 'Wrong input: (year<1996)'
elseif Year <= 1999 & strcmp(upper(type_of_measurements),'HIGH_LEVEL') == 0 & ~strcmp(upper(SiteID),'UBC_TOTEM')
