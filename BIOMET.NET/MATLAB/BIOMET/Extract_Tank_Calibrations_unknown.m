function [Report,co2stats] = Extract_Tank_Calibrations_unknown(PraxairSN, tankUBCSN, filePath, fileExt, co2_chan_num,points2avg)
...
arg_default('co2_chan_num',1);
arg_default('points2avg',150);

wildCard = ['*.' fileExt];

[fileName, pathName, filterIndex] = uigetfile(fullfile(filePath,wildCard),'Select UNKNOWN tank calibration data');
...
Report = sprintf('Tank calibration report for tank SN: CC%06d\n  UBC number: %03d\n',PraxairSN, tankUBCSN);
