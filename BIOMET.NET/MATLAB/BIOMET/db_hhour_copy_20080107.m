...
if now - lastTime >= 1-1/24  % July 3, 2007: Nick changed
	...
	for YearX = 2007:dateVec(1)
        ...
        % BS
        pthHH_db = ['y:\' strYear '\bs\hhour_database'];
        ...
        % CR 
        pthHH_db = ['y:\' strYear '\cr\hhour_database'];
        cmdStr = ['echo ========================================================================================      >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        ...
        % HJP02
        pthHH_db = ['y:\' strYear '\hjp02\hhour_database'];
        cmdStr = ['echo ========================================================================================      >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        ...
        % HJP75
        pthHH_db = ['y:\' strYear '\hjp75\hhour_database'];
        cmdStr = ['echo ========================================================================================      >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        ...
        % OY
        pthHH_db = ['y:\' strYear '\oy\hhour_database'];
        cmdStr = ['echo ========================================================================================      >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        ...
        % PA 
        pthHH_db = ['y:\' strYear '\pa\hhour_database'];
        cmdStr = ['echo ========================================================================================      >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        ...
        % YF
        pthHH_db = ['y:\' strYear '\yf\hhour_database'];
        cmdStr = ['echo ========================================================================================      >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
        cmdStr = ['echo ' datestr(Now) ' >' '> ' pthHH_db '\hhour_copy.log']
        dos(cmdStr)
