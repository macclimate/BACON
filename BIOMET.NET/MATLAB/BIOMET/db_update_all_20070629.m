...
% Revisions:
%   June 28, 2007:
%       -Nick modified to explicitly clean by site, since using
...
if runCleaning == 1
    ...
    % problem with one site; this way the loop will continue with the next
    % site
    sites = {'BS' 'CR' 'FEN' 'HJP02' 'HJP75' 'JP'  'OY' 'PA' 'YF'}; 
    for i=1:length(sites)
        eval_wrapper(['Automatic cleaning of current year for ' sites{i} ],'fr_automated_cleaning(yy(1),sites{i})');
    end
