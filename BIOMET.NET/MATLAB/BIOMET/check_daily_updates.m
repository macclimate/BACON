...
% Dec 3, 2014: update smtp server address and e-mail addresses, remove
%    HDF11 from updates

Sites     = {'BS' 'PA'  'YF' 'MPB1' 'HP09' 'HP11'};
hhour_new = {'BS' 'PA'  'YF' 'MPB1' 'HP09' 'HP11'}; % sites for which we receive HF data
Site_name = {'BS' 'PA'  'YF' 'MPB1' 'HP09' 'HP11'};
...
setpref('Internet',{'SMTP_Server','E_mail'},...
    {'smtp.mail-relay.ubc.ca','nesic@interchange.ubc.ca'});
...
sendmail('jilmariestephens@gmail.com',subject_line,message(:)');
return
