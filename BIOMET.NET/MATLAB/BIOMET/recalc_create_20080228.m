...
%==========================================================================
% Create second and thirdstage database (for comparison with current
% resutls)
disp('Creating second and third stage database ...');
[s,mes] = mkdir(base_dir,'database');
pth = pwd;
cd(base_dir); % This causes the cleaning log file to be created in base_dir
fr_automated_cleaning(Years,SiteId,[2 3],[base_dir '\database'])
cd(pth);
diary(fullfile(base_dir,'recalc.log'));
disp(sprintf('== Finisched recalculation setup =='));
