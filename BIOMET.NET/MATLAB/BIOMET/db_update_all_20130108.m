...
if runCleaning == 1
    ...
    if strcmp(dayOfWeek,'Sat') & yy(3) <= 7
        ...
        eval_wrapper('DIS data export','fr_automated_cleaning(yy(1)-1:yy(1),{''bs'',''pa'',''yf''},4)'); % removed hjp02: July 20, 2011
...
eval_wrapper('Exporting HP web plots','fr_automated_cleaning(2013,{''HP09'' ''HP11''},6);');
