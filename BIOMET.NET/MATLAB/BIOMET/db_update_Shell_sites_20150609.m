...
for k=1:length(yearIn)
    for j=1:length(sites)
        ...
        eval(['[numOfFilesProcessed,numOfDataPointsProcessed] = fr_site_met_database(''d:\sites\' siteId '\CSI_net\old\' num2str(yearIn(k)) '\' siteId '_OneMinuteAvg.*'',[],[],[],progressListShell_' siteId '_Clim_OneMinute_Pth,Shell_' siteId '_OneMinuteDatabase_Pth,2,[],1);'])
