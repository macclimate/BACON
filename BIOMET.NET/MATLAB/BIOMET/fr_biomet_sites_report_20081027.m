...
% 
% Example:
% hhourly cumulative plots and 10 day averaging with HF data to DOY 260
% fr_biomet_sites_report(2000:2008,'BS','nep_filled_with_fits',0,'Cumulative NEP',0,0,0,[],[],260);
% fr_biomet_sites_report(2000:2008,'BS','nep_filled_with_fits',5,'10-day mean NEP',3,3,0,[],10,260);
% fr_biomet_sites_report(2000:2008,'BS','eco_photosynthesis_filled_with_fits',0,'Cumulative GEP',0,0,0,[],[],260);
% fr_biomet_sites_report(2000:2008,'BS','eco_photosynthesis_filled_with_fits',5,'10-day mean GEP',3,3,0,[],10,260);
% fr_biomet_sites_report(2000:2008,'BS','eco_respiration_filled_with_fits',0,'Cumulative R',0,0,0,[],[],260);
% fr_biomet_sites_report(2000:2008,'BS','eco_respiration_filled_with_fits',5,'10-day mean R',3,3,0,[],10,260);
% fr_biomet_sites_report(2000:2008,'BS','air_temperature_main',8,'10-day mean T_{air} (\circC)',0,0,0,[],10,260);
% fr_biomet_sites_report(2000:2008,'BS','soil_temperature_main',8,'10-day mean T_{soil} (\circC)',0,0,0,[],10,260);
% fr_biomet_sites_report(2000:2008,'BS','ppfd_downwelling_main',6,'10-day mean PAR',2,3,0,[],10,260);
% fr_biomet_sites_report(2000:2008,'BS','precipitation',4,'Precipitation (mm)',0,0,0,[],[],260);
