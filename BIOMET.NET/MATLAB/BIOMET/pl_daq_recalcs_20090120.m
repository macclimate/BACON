...
% plot select traces from a set of recalc'ed mat files

%year = 2002;

% % path for mat files
% pth_oldcal        = '\\Fluxnet02\BS_HFREQ_2002\met-data\hhour\short_mat_files';
% pth_newcal        = 'D:\Nick_Share\recalcs\BS\recalc_20070213\hhour'; 
