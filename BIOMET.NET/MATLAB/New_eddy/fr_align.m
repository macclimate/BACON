...
% Revisions:
% July 8, 2015 (Nick)
%   -test for array length in find_delay changed to accommodate the case
%   where the IRGA trace has fewer elements than the sonic N > n changed to
%   N >= n. (This was preventing delay calculation for the case where n=N)
% May 5, 2009 (Zoran)
...
%if N > n % Nick, July 8, 2015
if N >= n
   %delay(x(1:n,chan(1)),y(1:n,chan(2)),del_span); pause;
