function [NEP,R,GEP,NEPgf,Rgf,GEPgf,RHat,GEPHat,RHat0,GEPHat0,cR,cGEP,t] = Call_fcrn_CO2Flux2NEP_365days_original(SiteId,date_start,uStarTH,mSEBClosure,flag_cleaning)
...
switch upper(SiteId)
    case {'CR','OY','YF'}
        [NEP,R,GEP,NEPgf,Rgf,GEPgf,RHat,GEPHat,RHat0,GEPHat0,cR,cGEP] = ...
            FCRN_optimized_for_CR_original(t,NEE,uStar,PPFD,Ta,Ts,PPFDGF,TaGF,TsGF,isNight,uStarTH,mSEBClosure,[],[]); 
    otherwise
        %[NEP,R,GEP,NEPgf,Rgf,GEPgf,RHat,GEPHat,RHat0,GEPHat0,cR,cGEP] = ...
            %FCRN_CO2Flux2NEP_original(t,NEE,uStar,PPFD,Ta,Ts,PPFDGF,TaGF,TsGF,isNight,uStarTH,mSEBClosure,['Ndspk_UBCnsgf_' num2str(dv(1)-1) '.txt'],[]); 
        
        [NEP,R,GEP,NEPgf,Rgf,GEPgf,RHat,GEPHat,RHat0,GEPHat0,cR,cGEP] = ...
            FCRN_CO2Flux2NEP_25aug2007(t,NEE,uStar,PPFD,Ta,Ts,PPFDGF,TaGF,TsGF,isNight,uStarTH,mSEBClosure,[],[]); 
end
