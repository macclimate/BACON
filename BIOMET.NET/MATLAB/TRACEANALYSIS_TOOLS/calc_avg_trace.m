...
%           Jan 07, 2005 Removed div by zero errors and made regression easier to follow (crs)
%           April 30, 2009- Nick fixed indexing errors in the moving window
...
%                end
               ...
               if length(check_data_out) == 1 & check_data_out(1) == 0
