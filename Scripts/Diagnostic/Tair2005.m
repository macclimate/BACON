...
avgT_2005_gs = mean(M1_dayavg_2005(150:240));

avgT_2006 = mean(M1_dayavg_2006);
avgT_2006_gs = mean(M1_dayavg_2006(150:240));
...
legend('M1 2005', 'M1 2006');
grid on;
text(150,7.5,['2005 Avg T = ' num2str(avgT_2005)]);
text(150,2.5, ['2005 GS Avg T = ' num2str(avgT_2005_gs)]);
text(150,-2.5,['2006 Avg T = ' num2str(avgT_2006)]);
text(150,-7.5, ['2006 GS Avg T = ' num2str(avgT_2006_gs)]);
