function out = fitresp_2A_sf(c_hat,x)
%%% fitresp_2A: Logistic (RE-Ts) function with a scaling function included
%%% (externally-defined VWC-related scaling function)
...
if nargin > 1
         y_hat = ((c_hat(1))./(1 + exp(c_hat(2).*(c_hat(3)-x(:,1))))).*x(:,2);
