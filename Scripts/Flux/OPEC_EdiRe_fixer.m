...
Ta = met.data(:,2);
[NEE_raw dcdt Jtfill dcdt_1h dcdt_2h] = OPEC_storage(site, master.data(:,2), Fc_in, CO2_top, CO2_cpy, Ta);
...
calc_master.data = [master.data(:,1:6) w_mean w_std H2O_top Pressure... % cols 1-10
    Ts Ta Wind_Speed u_std u_star Jtfill CO2_top CO2_cpy dcdt dcdt_1h dcdt_2h Fc_in ...
    NEE_cleaned LE_cleaned Hs_cleaned Htc_cleaned Fc_rot_wpl_B NEE_wpl_B_cleaned LE_wpl_B_cleaned]; % cols 21-22
calc_master.labels = {'TimeVec'; 'Year'; 'Month'; 'Day'; 'Hour'; 'Minute'; 'w_mean'; 'w_std'; 'H2O_top'; 'Pressure';...
    ...
    'NEE_noBurba'; 'LE_noBurba'; 'Hs_cleaned'; 'Htc_cleaned'; 'Fc';'NEE_cleaned';'LE_cleaned'};
