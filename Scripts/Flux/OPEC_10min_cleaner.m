function [] = OPEC_10min_cleaner(site)
...
load([load_path site '_OPEC_10min_master.mat']);

%%% Clean the data using thresholds
% site = input('Enter Site Name (e.g. TP74, TP02, etc): ','s'); %Gets site name
% load threshold file:
thresh = jjb_hdr_read([thresh_path site '_OPEC_thresholds.csv'],',');
...
switch site
    case 'TP74'
        % fixes upside-down Htc readings from backwards-made thermocouple.
        % NOTE: The actual fw variable (column 50) does not have to be
        % inverted, as the temperature is correct:
   ind_fix1 = [41574:43591 85924:124920 157490:205694]';
   cols_to_fix1 = [13 23 30 36 41 43];
   master.data(ind_fix1,cols_to_fix1) = master.data(ind_fix1,cols_to_fix1).*-1;
clear *fix1;
    case 'TP89'
        % fixes upside-down Htc readings from backwards-made thermocouple.
     ind_fix1 = [87233:88900 99168:110510 136463:139841 164390:236357]';   
%    ind_fix1 = [92401:93961 136463:139842 205732:236357]';
cols_to_fix1 = [13 23 30 36 41 43];
master.data(ind_fix1,cols_to_fix1) = master.data(ind_fix1,cols_to_fix1).*-1;
clear *fix1;
    case 'TP02'
        % fixes upside-down Htc readings from backwards-made thermocouple.
     ind_fix1 = [88945:90622 111266:114114 166999:201073 ]';   
cols_to_fix1 = [13 23 30 36 41 43];
master.data(ind_fix1,cols_to_fix1) = master.data(ind_fix1,cols_to_fix1).*-1;
clear *fix1;
end
...
% Quick Test:
figure(99);clf;
plot(master.data(:,50));hold on;
plot(master.data(:,51),'r');
axis([1 length(master.data) -50 50]);
legend('fw','Ts');
...
disp(['saving data to ' save_path site '_OPEC_10min_cleaned.mat']);
save([save_path site '_OPEC_10min_cleaned.mat'],'master');
disp('done!')
