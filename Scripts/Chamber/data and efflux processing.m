...
%%FROM SCRIPT 'basic efflux calc'
 'cd C:\DATA';
ACS_calc_and_save(datenum(2008,07,01):datenum(2009,05,12),16,'C:\DATA',1,0);
...
% cleaned_Ch5_09(cleaned_Ch5_09 < 0.000001,1) = NaN;
% 
% cleaned_Ch6_09 = output_2009(:,46);
% cleaned_Ch6_09(cleaned_Ch6_09 < 0.000001,1) = NaN;
