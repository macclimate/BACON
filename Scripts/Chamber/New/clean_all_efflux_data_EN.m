...
%load data and give name
C1_efflux_2008 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2008.C1_efflux');
C1_efflux_2009 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2009.C1_efflux');
C1_efflux_2010 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2010.C1_efflux');
C1_efflux_all  =[C1_efflux_2008;C1_efflux_2009;C1_efflux_2010]; %combine all data to make 1 variable

C2_efflux_2008 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2008.C2_efflux');
C2_efflux_2009 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2009.C2_efflux');
C2_efflux_2010 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2010.C2_efflux');
C2_efflux_all  =[C2_efflux_2008;C2_efflux_2009;C2_efflux_2010];

C3_efflux_2008 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2008.C3_efflux');
C3_efflux_2009 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2009.C3_efflux');
C3_efflux_2010 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2010.C3_efflux');
C3_efflux_all  =[C3_efflux_2008;C3_efflux_2009;C3_efflux_2010];

C4_efflux_2008 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2008.C4_efflux');
C4_efflux_2009 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2009.C4_efflux');
C4_efflux_2010 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2010.C4_efflux');
C4_efflux_all  =[C4_efflux_2008;C4_efflux_2009;C4_efflux_2010];

C5_efflux_2008 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2008.C5_efflux');
C5_efflux_2009 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2009.C5_efflux');
C5_efflux_2010 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2010.C5_efflux');
C5_efflux_all  =[C5_efflux_2008;C5_efflux_2009;C5_efflux_2010];

C6_efflux_2008 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2008.C6_efflux');
C6_efflux_2009 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2009.C6_efflux');
C6_efflux_2010 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2010.C6_efflux');
C6_efflux_all  =[C6_efflux_2008;C6_efflux_2009;C6_efflux_2010];

C7_efflux_2008 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2008.C7_efflux');
C7_efflux_2009 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2009.C7_efflux');
C7_efflux_2010 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2010.C7_efflux');
C7_efflux_all  =[C7_efflux_2008;C7_efflux_2009;C7_efflux_2010];

C8_efflux_2008 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2008.C8_efflux');
C8_efflux_2009 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2009.C8_efflux');
C8_efflux_2010 = load('C:\DATA\CHAMBER\annual_winter\TP39_chamber_2010.C8_efflux');
C8_efflux_all  =[C8_efflux_2008;C8_efflux_2009;C8_efflux_2010];

clc;

%Plot time series for chambers- soil CO2 efflux before cleaning
figure('Name','Efflux Time Series before Cleaning','NumberTitle','off'); 
hold on;
subplot (8,1,1);
hold on;
plot(C1_efflux_all,'-','Color',[0.69 0.11 0]);hold on;
axis([7296 49728 -1 13]);
title('Soil CO2 Efflux Ch1 Before Cleaning')
xlabel('HHOUR')
ylabel ('Soil CO2 Efflux (oC)');
legend('No Litter',1)
...
axis([7296 49728 -1 13]);
title('Soil CO2 Efflux Ch2 Before Cleaning')
xlabel('HHOUR')
...
axis([7296 49728 -1 13]);
title('Soil CO2 Efflux Ch3 Before Cleaning')
xlabel('HHOUR')
ylabel ('Soil CO2 Efflux (umol CO2 m-2 s-1)');
legend('Trenched',1)
...
axis([7296 49728 -1 13]);
title('Soil CO2 Efflux Ch4 Before Cleaning')
xlabel('HHOUR')
ylabel ('Soil CO2 Efflux (umol CO2 m-2 s-1)');
legend('Drought 1',1)
...
axis([7296 49728 -1 13]);
title('Soil CO2 Efflux Ch5 Before Cleaning')
xlabel('HHOUR')
ylabel ('Soil CO2 Efflux (umol CO2 m-2 s-1)');
legend('Control 2',1)
...
axis([7296 49728 -1 13]);
title('Soil CO2 Efflux Ch6 Before Cleaning')
xlabel('HHOUR')
ylabel ('Soil CO2 Efflux (umol CO2 m-2 s-1)');
legend('Drought 2',1)
...
axis([7296 49728 -1 13]);
title('Soil CO2 Efflux Ch7 Before Cleaning')
xlabel('HHOUR')
ylabel ('Soil CO2 Efflux (umol CO2 m-2 s-1)');
legend('Reference',1)
...
axis([7296 49728 -1 13]);
title('Soil CO2 Efflux Ch8 Before Cleaning')
xlabel('HHOUR')
ylabel ('Soil CO2 Efflux (umol CO2 m-2 s-1)');
legend('Hetero/Dro',1)
...
%%Clean Data of zero's where it occurs every 48 hhour due to system restart
%(noise in the data)

%%ind = find(C1_efflux_all <= 0); 
C1_efflux_all(C1_efflux_all == 0,1)=NaN;
%%ind = find(C2_efflux_all <= 0); 
C2_efflux_all(C2_efflux_all == 0,1)=NaN;
%%ind = find(C3_efflux_all <= 0); 
C3_efflux_all(C3_efflux_all == 0,1)=NaN;
%%ind = find(C4_efflux_all <= 0); 
C4_efflux_all(C4_efflux_all == 0,1)=NaN;
%%ind = find(C5_efflux_all <= 0); 
C5_efflux_all(C5_efflux_all == 0,1)=NaN;
%%ind = find(C6_efflux_all <= 0); 
C6_efflux_all(C6_efflux_all == 0,1)=NaN;
%%ind = find(C5_efflux_all <= 0); 
C7_efflux_all(C7_efflux_all == 0,1)=NaN;
%%ind = find(C6_efflux_all <= 0); 
C8_efflux_all(C8_efflux_all == 0,1)=NaN;
