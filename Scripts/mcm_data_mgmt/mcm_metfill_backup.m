...
%%%
% temp(1).Ta temp(1).RH temp(1).PAR temp(1).WS
...
for fill_loop = 1:1:4
    ...
    for i = 1:1:num_sites
site = site_labels(i,:);
% left_side = [left_side site '_filled(:,fill_loop) ']; 
right_side = [right_side site '(:,fill_loop) '];
    ...
    for i = 1:1:num_sites
site = site_labels(i,:);
eval([site '_filled(:,' num2str(fill_loop) ') = data_filled(:,' num2str(i) ');']);
    end
    clear data_filled;
