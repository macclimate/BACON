function [C_out] = CO2_convert(C_in, Tair, BarPress, flag)
...
%                 to [(mg/m^3)*(m/s)] 
%               2 from  [(mg/m^3)*(m/s)] to [umol/mol/(m^2 s)]
%               3 from  [ppm * (m/s)] to [umol/mol/(m^2 s)]
%               4 from  [(mg/m^3) * (m/s)] to [ppm * (m/s)]
%               5 from  [umol/mol/(m^2 s)] to [(mg/m^3) * (m/s)]
%               6 from  [umol/mol/(m^2 s)] to [ppm * (m/s)]
%   or
%            for concentrations 
