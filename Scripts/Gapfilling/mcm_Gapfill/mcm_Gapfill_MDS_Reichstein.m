function [final_out f_out] = mcm_Gapfill_MDS_Reichstein(data, plot_flag, debug_flag)
...
for j = 1:1:length(st_pts)
    ...
    [c_hat_Rref_long(j,1:2), y_hat, y_pred, stats, sigma, err, exitflag, num_iter] = ...
    ...
    [c_hat_Rref_short(j,1:2), y_hat, y_pred, stats, sigma, err, exitflag, num_iter] = ...
