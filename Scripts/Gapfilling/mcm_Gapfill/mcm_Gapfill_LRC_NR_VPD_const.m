function [final_out f_out] = mcm_Gapfill_LRC_NR_VPD_const(data, plot_flag, debug_flag)
...
%%% Windowed Parameterization:
    ...
    fun_name = 'fitGEP_LRC_NR_VPD';
    coeffs_use = [1 2 3 4 5];
...
disp('mcm_Gapfill_LRC_NR_VPD_const done!');
