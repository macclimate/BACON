...
fig_path = 'C:\HOME\MATLAB\Figs\TP04_figs/';
...
b_avg_Ts = jjb_blockavg(Ts(i).all(ind_good(i).day), NEPraw(i).all(ind_good(i).day),      0.50, 80, -30);
b_avg_T_air = jjb_blockavg(T_air(i).all(ind_good(i).day), NEPraw(i).all(ind_good(i).day),0.50, 80, -30);
b_avg_PAR = jjb_blockavg(PAR(i).all(ind_good(i).day), NEPraw(i).all(ind_good(i).day),    100, 80, -30); axis([0 2 -.1 .3])
b_avg_ustar = jjb_blockavg(ustar(i).all(ind_good(i).day), NEPraw(i).all(ind_good(i).day),  0.05, 80, -30);
b_avg_VPD = jjb_blockavg(VPDmd(i).all(ind_good(i).VPDmd), NEP(i).all(ind_good(i).VPDmd),    0.1, 5, -0.5);
b_avg_SM = jjb_blockavg(SM(i).all(ind_good(i).day), NEPraw(i).all(ind_good(i).day),      0.0025, 80, -30);
% % Block average data to see average trends --_ NIGHTTIME
b_avg_Tsn = jjb_blockavg(Ts(i).all(ind_good(i).night), NEPraw(i).all(ind_good(i).night),      0.50, 80, -30);
b_avg_T_airn = jjb_blockavg(T_air(i).all(ind_good(i).night), NEPraw(i).all(ind_good(i).night),0.50, 80, -30);
b_avg_PARn = jjb_blockavg(PAR(i).all(ind_good(i).night), NEPraw(i).all(ind_good(i).night),    100, 80, -30); axis([0 2 -.3 0])
b_avg_ustarn = jjb_blockavg(ustar(i).all(ind_good(i).night), NEPraw(i).all(ind_good(i).night),  0.05, 80, -30);
b_avg_VPDn = jjb_blockavg(VPDmd(i).all(ind_good(i).VPDmd), NEP(i).all(ind_good(i).VPDmd),    0.1, 5, -0.5);
b_avg_SMn = jjb_blockavg(SM(i).all(ind_good(i).night), NEPraw(i).all(ind_good(i).night),      0.0025, 80, -30);
...
% b_avg_Ts1 = jjb_blockavg(Ts1, NEPraw1, 0.50, 80, -30);
% b_avg_T_air1 = jjb_blockavg(T_air1, NEPraw1 ,0.50, 80, -30);
% b_avg_PAR1 = jjb_blockavg(PAR1, NEPraw1,    100, 80, -30);
% b_avg_ustar1 = jjb_blockavg(ustar1, NEPraw1,  0.05, 80, -30);
% b_avg_VPD1 = jjb_blockavg(VPD1, NEP_VPD,    0.1, 5, -0.5);
% b_avg_SM1 = jjb_blockavg(SM1, NEPraw1,      0.0025, 80, -30);
% 
...
%% Try to correct soil moisture:
Tcoef = -3.46e-4 + 0.019.*SM5a1 - 0.045.*SM5a1;
Tcoef = Tcoef.*(Ts1_5-20);
SMcorr = SM5a1 - Tcoef;
figure(88); clf
% plot(Tcoef); hold on
plot(SMcorr,'b'); hold on;
plot(SM5a1,'g')
