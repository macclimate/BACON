...
% cumu_phi_nr is 401x201 in size, corresponding to x_x and y_y;
% x=0 is at point 201, 
Xind = (50:5:95);
Xdist =(50:5:95);
for i = 1:1:size(Xind,2)
    Xind(2,i) = find(cumu_phi_nr(:,201)<Xind(1,i),1,'first');
    Xdist(2,i) = y_y(Xind(2,i),1);
end
%%
