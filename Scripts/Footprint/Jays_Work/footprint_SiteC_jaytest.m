...
function footprint_SiteC_jaytest(year)
...
%         y_y = flipud(y_y);
        ...
        if fig_ctr ==10
            ...
            if sp_ctr == 5;
                figure(1);
                print('-dpng',['/1/fielddata/Matlab/Data/Flux/Footprint/KM_footprint_test/figs/fp'  timetag '_dp_' num2str(i)])
                clf;
                figure(2);
              print('-dpng',['/1/fielddata/Matlab/Data/Flux/Footprint/KM_footprint_test/figs/cumfp'  timetag '_dp_' num2str(i)])
              clf;
                sp_ctr = 1;
            end
...
% save([output_path 'inbounds_p.mat'],'inbounds_prop');
 out.Xind = Xind;
       ...
       save([output_path 'KM_TP39_' num2str(year) '_results.mat'],'out');
end
%{
