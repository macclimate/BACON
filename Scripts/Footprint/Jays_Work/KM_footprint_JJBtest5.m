function KM_footprint_JJBtest5
...
%         [phi,f,D_y,xs,ys,param] = footprint_kormann_and_meixner_bob(z_0,z_m,u_tmp,ust_tmp,sig_v_tmp,L(i,1),y_max,x_max,pix);
        [phi,f,D_y,xs,ys,param] = footprint_kormann_and_meixner_bob(z_0,z_m,u_tmp,ust_tmp,sig_v_tmp,Lstar(i,1),y_max,x_max,pix);
%         phi = real(phi);phi(isnan(phi))=0;
        ...
        if sp_ctr == 5;
            figure(f1);set(gcf,'visible','off')
            print('-dpng',['/home/brodeujj/Matlab/Data/KM_footprint_test/JJBtest5-figs/fp_run_' num2str(i-3) '-' num2str(i)])
            clf;
            figure(f2);set(gcf,'visible','off')
            print('-dpng',['/home/brodeujj/Matlab/Data/KM_footprint_test/JJBtest5-figs/cumfp_run_' num2str(i-3) '-' num2str(i)])
            clf;
            sp_ctr = 1;
        end
...
save([output_path 'KMtest5_' num2str(year) '_results.mat'],'out');
end