function KM_footprint_JJBtest3
...
for i = 1:1:num_runs
    ...
    try
        ...
        if sp_ctr == 5;
            figure(f1);set(gcf,'visible','off')
            print('-dpng',['/home/brodeujj/Matlab/Data/KM_footprint_test/JJBtest3-figs/fp_run_' num2str(i-3) '-' num2str(i)])
            clf;
            figure(f2);set(gcf,'visible','off')
            print('-dpng',['/home/brodeujj/Matlab/Data/KM_footprint_test/JJBtest3-figs/cumfp_run_' num2str(i-3) '-' num2str(i)])
            clf;
            sp_ctr = 1;
        end
...
save([output_path 'KMtest3_' num2str(year) '_results.mat'],'out');
end