function [out] = mcm_get_fluxsystem_info(site, datatype, year)
if nargin==2
    year = [];
end
%%
switch datatype
    ...
    case 'data_extensions' % for mcm_extract_datafiles
        switch site
            case 'TP39';                tag = {'.DMCM4', '.DMCM5', '.DMCM6'}; % JJB: Added .DMCM6 in Jan 2022 to accomodate switch to LI7200 in Aug 2021
    ...
    case 'checkfiles' % for use in mcm_checkfiles
        ...
        site_info(1).data_tag(1,1) = cellstr('.DMCM4'); site_info(1).data_tag(2,1) = cellstr('.DMCM5');  site_info(1).data_tag(3,1) = cellstr('.bin'); site_info(1).data_tag(4,1) = cellstr('.DMCM6');%site_info(1).data_tag(3,1) = cellstr('.DMCM6');
        site_info(1).datafilesize(1,1) = 420000; site_info(1).datafilesize(1,2) = 300000;  site_info(1).datafilesize(1,3) = 500000; site_info(1).datafilesize(1,4) = 700000;
