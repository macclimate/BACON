...
try
    ...
    Dates(4) = datenum(2012,7,26,17,0,0); % Using LI-7000 serial connection, PDQ3000 Disconnected.
...
%%% This part modified by JJB on 16-Oct-2012, to retroactively accommodate PDQ removal        
...
%         c.Instrument(nIRGA).Poly = []; % Changed by JJB - 16-Apr-2012
    ...
    c.System(nMainEddy).Name            = 'Main EC systen, CR site';            % long system name
    ...
    c.System(nMainEddy).Alignment.Enable = 1;                   %  Added May, 2010 by JJB
